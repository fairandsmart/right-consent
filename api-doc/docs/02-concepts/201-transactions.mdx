...
In the **ConsentContext**, you can specify the `layout` field. It must be the id of a custom layout. You can create and save custom layouts using the Consent Manager GUI.
